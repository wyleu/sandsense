...
# Sandsense
# ---------------------------------------------------------------------------
# Required facts the firmware must supply (missing → "—", not a crash):
#
#   id, name, family, role, location
#   ip, ssid
#   pll_enabled, pll_locked, misses
#   tick_count, report_interval_s, last_tpm, tick_seq
#   adc_avg, temp_c
#   tick_led_enabled, tick_led_red
#   last_line
#   ts
#
# Optional: uptime_s, mode (default "escapement")
