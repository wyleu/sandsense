...
bus = smbus2.SMBus(1)
INT_pin = 17 ##  Modified for Sandsense
GPIO.setup(INT_pin, GPIO.IN, pull_up_down=GPIO.PUD_UP)

encoder = i2cEncoderLibV2.i2cEncoderLibV2(bus, 0x47)   ##  Modified for Sandsense
...
GPIO.add_event_detect(INT_pin, GPIO.FALLING, callback=Encoder_INT, bouncetime=10)   # Commented For sandsense
